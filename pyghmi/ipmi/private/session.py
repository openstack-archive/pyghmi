...
from pyghmi.exceptions import InvalidParameterValue
from pyghmi.exceptions import UnimplementedError
    ...
    def send_payload(self, payload=None, payload_type=None, retry=True,
        ...
        if (self.ipmiversion == 2.0):
            ...
            if (baretype == 2):
                ...
                raise UnimplementedError("OEM Payloads")
            elif baretype not in constants.payload_types.values():
                raise UnimplementedError("Unrecognized payload type %d" % baretype)
    ...
    def _xmit_packet(self, retry=True, delay_xmit=None):
        ...
        if self.sockaddr:
            ...
            try:
                ...
                raise IpmiException("Unable to transmit to specified address")
