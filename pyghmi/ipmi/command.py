...
class Command(object):
    ...
    def _chunkwise_dcmi_fetch(self, command):
        szdata = self.xraw_command(netfn=0x2c, command=command, data=(0xdc, 0, 0))
    ...
    def set_mci(self, mci):
        """Set management controller identifier, per DCMI specification

        The MCI is what is supposed to be used for DHCP host name when
        implemented
        """
        return
