...
class Command(object):
    ...
    def get_channel_access(self, channel=1, read_mode='non_volatile'):
        """Get channel access
    ...
    def set_user_access(self, uid, channel=1, callback=False, link_auth=True,
    ...
    def user_delete(self, uid, channel=1):
        ...
        ## TODO: perhaps should set user access on all channels
