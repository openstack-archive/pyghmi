...
class Command(object):
    ...
    def get_alert_destination(self, destination=0, channel=None):
        ...
        destinfo['address'] = '{0}.{1}.{2}.{3}'.format(*(struct.unpack('4B', rsp['data'][4:8])))
        return destinfo



    def set_channel_access(self, channel=None, access_update_mode='non_volatile',
    ...
    def set_user_access(self, uid, channel=None, callback=False, link_auth=True,
