...
class EventHandler(object):
    ...
    """
        ...
        self._fix_sel_time(records, ipmicmd)

    def _fix_sel_time(self, records, ipmicmd):
        ...
        for index in reversed(xrange(len(records))):
            ...
            if record['description'] == 'Clock time change: After':
                ...
                if record['timestamp'] < 0x20000000:  # uptime timestamp
                    ...
                    print repr(correctednowtime - listtimestamp)
                else:
                    ...
                    if correctednowtime < 0x20000000:
                        ...
                        record['datetime'] = ipmi2calendar(record['timestamp'])
                    else:
                        print correctednowtime
                        age = correctednowtime - record['timestamp']
                        record['datetime'] = time.strftime(
