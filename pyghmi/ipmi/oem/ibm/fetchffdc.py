...
class FFDCFetcher(object):
    ...
    def fetch_datastore_name(self, name, log_stream, waitforready=False):
        ...
        # stream is not opened or not writable: abort
        if not log_stream.opened or log_stream.mode not in ['w', 'a']:
            return False
    ...
    def fetch_ffdc_file(self, log_stream):
        ...
        # fetch the ffdc
        success = self.fetch_datastore_name(
            b'ffdc.tgz',
            log_stream,
            waitforready=True
        )
